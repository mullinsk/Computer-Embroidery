...
for fileName in os.listdir('.'):
	if os.path.isfile(fileName) & fileName.endswith("png"):
		print "Reanalyzing " + fileName
		...
		circles = cv2.HoughCircles(dst,cv.CV_HOUGH_GRADIENT,1,50,param1=50,param2=50,minRadius=10,maxRadius=0)
		...
		with open('../cfa/'+base+'-it.cfdg', 'w') as outfile: 
			outfile.write(final)
